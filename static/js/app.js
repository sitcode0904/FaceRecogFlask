! function() {
    ...
    function n(e) {
        document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = "{{ url_for('static', filename='images/flags/us.svg') }}" : "sp" == e ? document.getElementById("header-lang-img").src = "{{ url_for('static', filename='images/flags/spain.svg') }}" : "gr" == e ? document.getElementById("header-lang-img").src = "{{ url_for('static', filename='images/flags/germany.svg') }}" : "it" == e ? document.getElementById("header-lang-img").src = "{{ url_for('static', filename='images/flags/italy.svg') }}" : "ru" == e ? document.getElementById("header-lang-img").src = "{{ url_for('static', filename='images/flags/russia.svg') }}" : "ch" == e ? document.getElementById("header-lang-img").src = "{{ url_for('static', filename='images/flags/china.svg') }}" : "fr" == e ? document.getElementById("header-lang-img").src = "{{ url_for('static', filename='images/flags/french.svg') }}" : "ar" == e && (document.getElementById("header-lang-img").src = "{{ url_for('static', filename='images/flags/ae.svg') }}"), localStorage.setItem("language", e), null == (a = localStorage.getItem("language")) && n(t), (e = new XMLHttpRequest).open("GET", "assets/lang/" + a + ".json"), e.onreadystatechange = function() {
            var a;
    ...
    function T(n, e) {
        Array.from(document.querySelectorAll("input[name=" + n + "]")).forEach(function(a) {
            e == a.value ? a.checked = !0 : a.checked = !1, a.addEventListener("change", function() {
                ...
                }, 9000), document.getElementById("customizerclose-btn").click()) : "data-preloader" == n && "disable" == a.value && (document.documentElement.setAttribute("data-preloader", "disable"), document.getElementById("customizerclose-btn").click()), "data-bs-theme" != n && "data-theme" != n && "data-theme-colors" != n || window.dispatchEvent(x), "data-theme" == n && (document.documentElement.setAttribute("data-theme", a.value), document.getElementById("body-img").style.display = "galaxy" === a.value ? "block" : "none", "galaxy" === a.value ? (document.documentElement.setAttribute("data-sidebar", "dark"), document.documentElement.setAttribute("data-bs-theme", "dark")) : (document.documentElement.setAttribute("data-sidebar", sessionStorage.getItem("data-sidebar")), document.documentElement.setAttribute("data-bs-theme", sessionStorage.getItem("data-bs-theme")))), "data-theme-colors" != n && "data-theme" != n || setTimeout(() => {
